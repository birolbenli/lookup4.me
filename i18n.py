...
TR: dict[str, str] = {
    ...
    "Mail Tester: {mail}/day per IP. Other tools: {tools}/day per IP (shared). Limits reset at UTC midnight.": "Mail Tester: IP başına günde {mail}. Diğer araçlar: IP başına günde {tools} (ortak). Limitler UTC gece yarısında sıfırlanır.",
